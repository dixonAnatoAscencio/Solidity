...
contract causasBeneficas{
    ...
    //Esta funcion nos devuelve true en cado de que podamos donar a una causa y false en caso de que no.
    function objetivoCumplido(string memory _nombre, uint _donar) private  returns(bool){
        bool flag = false;
    ...
    //Esta funcion nos dice si hemos llegamos al precio objetivo
